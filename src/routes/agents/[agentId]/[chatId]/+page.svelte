            ...
            <div class="row-span-5 overflow-auto">
                ...
                <ul>
                    ...
                    <li>
                      ...
                      <div class="text-left text-true-white text-md bg-true-white bg-opacity-5 rounded-xl my-2 "><pre class="w-full p-2 px-4 overflow-auto whitespace-pre-wrap ">{message.content}<pre/></div>
